...
<script>
    ...
    function submitCase() {
        document.getElementById('submitCase').action = "<c:url value='refreshClusterCaseL2'/>";
...
<c:param name="typeOfView" value="clusterView"></c:param>
                            ...
                            <br>
                            <c:choose>
                                <c:when test="${typeOfView == 'clusterView'}">
                                    <div class="col-md-12">
                                        <c:choose>

...
<script>
    ...
    function submitHit() {
        ...
        if (comment != ''){
            ...
            document.getElementById('leveloneform').action = "/MVS/saveMVSL2Result?sno=" + sno + "&verifyStatus=hit"+"&statusComment="+comment+"&requestId="+requestId;
...
<%--                                                <a class=" color-font "><b>Residential Address Field</b>--%>
<%--                                                    <textarea class="values" value="${CanDemoFields.presentAddressLine1}" readonly></textarea></a><br>--%>
                    ...
                    <div class="card-body">
                        <c:if test="${not empty reportPDFPOI}">
                            <div id="page">
                                ...
                                <div id="popup">
                                    <i id="closepdf" class="fa fa-times">Close</i>
...
<%--                                                                <input type="text" style="width:100%; padding: 0 7em 2em 0;"><br>--%>
                                        ...
                                        <input type="text"  style="width:100%; padding: 0 7em 2em 0;"  value="${op2Comment}" readonly>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header p-2">
                            ...
                            <%--                        <a class=" color-font"><b>Registration Area</b> <input class="values" style="width:260px" value="${probeDemoFields.registrationType}" readonly/></a><br>--%>
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header p-2">
                            ...
                            <%--                        <a class=" color-font"><b>Registration Area</b> <input class="values" style="width:260px" value="${CanDemoFields.registrationType}" readonly/></a><br>--%>
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-success" onclick=" alertNoHit()">No Hit</button>
                    <button type="button" class="btn btn-danger" onclick=" alertHit()">Hit</button>
                </div>
                ...
                <div id="myModal1" class="modal1">
                    ...
                    <!-- Modal Content (The Image) -->
                    <img class="modal-content" id="img02" draggable="false" ondragstart="drag(event)">

        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Fraud Management search</li>
                </ol>
            </div>
        </div>
    </div>
                            ...
                            <table id="example" class="table table-bordered table-hover">
                                ...
                                <c:forEach var="emp" items="${galleryList}" varStatus="counter">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${empty emp.supervisorUpdBy}">
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${empty emp.supervisorUpdatedDate}">
                                            <fmt:formatDate value="${emp.op2UpdatedDate}" type="date" pattern="dd-MMM-yyyy"/>
                                                </c:when>
                                                <c:otherwise>
                                                    <fmt:formatDate value="${emp.supervisorUpdatedDate}" type="date" pattern="dd-MMM-yyyy"/>
                                                </c:otherwise>
                                            </c:choose>
                                           </td>
                                        ...
                                        <td>
                                            <a href="<c:url value="levelthreeSearchByName">
...
<c:param name="supervisorComment" value="${emp.supervisorComment}"></c:param>
<c:param name="supervisorVerifyStatus" value="${emp.supervisorVerifyStatus}"></c:param>

...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#example').DataTable({
            ...
            "server-side": true,
            "ajax": {
                "url": "<c:url value='loadLevelThreeData'/>",
                "type": "GET"
            },
            "columns": [
                {"data": "sno"},
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        // Base URL
                        var baseUrl = "<c:url value='levelthreeSearchByName'/>";
        ...
        // Add event listener to the DataTable's page change
    ...
    function getValueByDate() {
        ...
        if (new Date(endDateInput.value) < new Date(startDateInput.value)) {
            ...
            $.ajax({
                url: "<c:url value='loadDataThree'/>",  // Backend endpoint (avoid JSP-specific tags)
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">Fraud Management Search</h3>
                    </div>
                    ...
                    <form id="myForm" style="padding: 1rem !important;">
                        <div class="row">
                            ...
                            <div class="col-3 pb-2">
                                <p>End Date</p>
                                <input type="date" onchange="checkSubmitButton()" name="endDate" class="form-control"
                                       id="endDate" disabled>
                            </div>

    ...
    <div class="five-zero-zero">
        <div class="five-zero-zero-container">
            ...
            <div class="button-place">
                <s:if test="%{#session.logon eq 'onlineUser'}">
                    <a href="logoutMfg" class="btn bg-light-green btn-lg waves-effect">GO TO HOME PAGE </a>
                </s:if>
                <s:else>
                    <a href="logout" class="btn bg-light-green btn-lg waves-effect">GO TO HOME PAGE </a>
                </s:else>
